...
public abstract class ArmorStandEntityRendererMixin extends LivingEntityRenderer<ArmorStandEntity,
  ...
  @ModifyReturnValue(method = "hasLabel(Lnet/minecraft/entity/decoration/ArmorStandEntity;)Z", at = @At("TAIL"))
  private boolean adjustHasLabel(boolean original, ArmorStandEntity entity) {
    if (!original) {
      return false;
    }
    ...
    if (maxSquaredDistance > 0) {
      return this.dispatcher.getSquaredDistanceToCamera(entity) < maxSquaredDistance;
    }
